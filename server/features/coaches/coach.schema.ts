...
export const coaches = pgTable("coaches", {
  ...
  headCoachYears: integer("head_coach_years").notNull().default(0),
  coordinatorYears: integer("coordinator_years").notNull().default(0),
  positionCoachYears: integer("position_coach_years").notNull().default(0),
