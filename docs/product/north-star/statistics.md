...
- **[League Setup](./league-setup.md):** Year 1 of a new league runs a shorter
  regular season and no preseason, so stat distributions for the inaugural year
  will look different than Year 2+. The league's first statistical leaders are
  the first ever — every leaderboard entry in a newly set-up league's record
  book was written by a human or NPC operator at this table.
