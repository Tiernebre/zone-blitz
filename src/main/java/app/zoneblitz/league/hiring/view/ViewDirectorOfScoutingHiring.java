...
/**
 * Internal hiring-view use case: load the HIRING_DIRECTOR_OF_SCOUTING page view-model for the
 * user's franchise. Empty when the league does not exist, is not owned by the user, or is not in
 * the DoS hiring phase. Consumed only by hiring-view controllers.
 */
interface ViewDirectorOfScoutingHiring {
