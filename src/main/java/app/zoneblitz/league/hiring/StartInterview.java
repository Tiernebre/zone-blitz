 ...
 *   <li>Counts against the team's daily interview capacity (default 2/day).
 ...
 * the team has already hit the daily cap, {@link InterviewResult.NotFound} when the league is not
 * owned or not in HC hiring, and {@link InterviewResult.UnknownCandidate} when the candidate id
